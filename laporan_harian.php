...
<head>
    <meta charset="utf-8">
    <title>SIPELBA - Laporan Harian</title>
            ...
            <!-- Table Start -->
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Data Laporan Harian</h6>
                                ...
                                <table class="table">
                                    ...
                                    <?php
                                        ...
                                        include "connection.php";
                                            ...
                                            $keyword = $_POST['cari'];
                                            $a = "SELECT * FROM lap_harian WHERE tanggal like '%$keyword%' or kronologi like '%$keyword%'
                                            order by id_laporan asc";
                                
                                            }else {
                                                $a="SELECT * from lap_harian order by id_laporan asc";
                                            }
                                        ...
                                        <tr>
                                            ...
                                            <a href="form_lapharian.php?ubah=<?php echo $c['id_laporan'] ?>" type="button" class="btn btn-warning" >
                                            ...
                                            <?php 
                                                if($_SESSION['level']== 'Admin'){
                                                ?>
                                                    <a href="surat_lapharian.php?id_laporan=<?=$c['id_laporan']?>" type="button" class="btn btn-info" >
                                                    <i class="bi bi-printer-fill"></i>
                                                    </a>

                                                    <a href="aksi_harian.php?hapus=<?php echo $c['id_laporan'] ?>" type="button" class="btn btn-danger" onClick="return confirm('Apakah anda yakin ingin menghapus data tersebut ???')" >
                        ...
                        <?php
                            if ($_SESSION['level'] == 'Admin'){
                        ?>      
                            <a href="download_harian.php" type="button" class="btn btn-warning"><i class="bi bi-cloud-arrow-down-fill"></i> Download Data</a>
                        <?php        
                        }else{
