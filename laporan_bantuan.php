        ...
        <div class="content">
            ...
            <!-- Table Start -->
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_POST['bcari'])){
                                            ...
                                            $keyword = $_POST['cari'];
                                            $a = "SELECT * FROM lap_bantuan WHERE kecamatan like '%$keyword%' or desa like '%$keyword%'
                                            order by id_bantuan asc";
                                
                                            }else {
                                                $a="SELECT * from lap_bantuan order by id_bantuan asc";
                                            }
                                        ...
                                        <tr> 
                                            ...
                                            <td>
                                            <a href="form_bantuan.php?ubah=<?php echo $c['id_bantuan'] ?>" type="button" class="btn btn-warning btn-sm" onClick="return confirm('Apakah anda yakin ingin mengubah data tersebut ???')">
                                            ...
                                            <?php 
                                                if($_SESSION['level']== 'Admin'){
                                                ?>
                                                    <a href="aksi_bantuan.php?hapus=<?php echo $c['id_bantuan'] ?>" type="button" class="btn btn-danger btn-sm" onClick="return confirm('Apakah anda yakin ingin menghapus data tersebut ???')">
                    ...
                    <?php
                        if ($_SESSION['level'] == 'Admin'){
                      ?>      
                            <a href="download_bantuan.php" type="button" class="btn btn-warning"><i class="bi bi-cloud-arrow-down-fill"></i> Download Data</a>
                    <?php        
                        }else{
