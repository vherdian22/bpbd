                ...
                <div class="row g-4">
                    <div class="col-sm-100 col-xl-100">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <select class="form-select form-select-sm mb-3"   id="level" name="level" aria-label=".form-select-sm example">
                                <option selected>Pilih Status</option>
                                <option <?php if($level == 'Admin'){ echo "selected";} ?> value="Admin">Admin</option>
                                <option <?php if($level == 'Lapangan'){ echo "selected";} ?> value="Lapangan">Lapangan</option>
                                <option <?php if($level == 'Operator'){ echo "selected";} ?> value="Operator">Operator</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input <?php if(!isset($_GET['ubah'])){ echo "required"; } ?> type="file" class="form-control" id="foto" name="foto" multiple>
                            </div>
                                ...
                                <a href="lihat_user.php" type="button" class="btn btn-danger">
